...
urlpatterns = [
    ...
    path('profile-<uuid>/', GetUserProfileDetailsView.as_view(), name="profile_details"),
    path('profile/address/update-<uuid>/', UpdateUserAddressView.as_view(), name="update_profile_address"),
    path('provinces/', GetProvinceListView.as_view(), name="provinces"),
    path('districts/', GetDistrictListView.as_view(), name="districts"),
    path('profile/update-<uuid>/', UpdateUserProfileView.as_view(), name="update_profile"),
